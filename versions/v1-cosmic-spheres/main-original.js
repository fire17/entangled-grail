...
{	
	...
	function setupScene ()
	{
		...
		var positions = new Float32Array(5000 * 3);
		var colors = new Float32Array(5000 * 3);
		for (let i = 0; i < 5000; i++) {
			positions[i*3] = Math.random() * 5000 - 2000;
			positions[i*3+1] = Math.random() * 5000 - 2000;
			positions[i*3+2] = Math.random() * 5000 - 2000;
	...
	function createParticles(size, color) {
		...
		let positions = new Float32Array(35000 * 3);
